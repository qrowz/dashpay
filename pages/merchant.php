	...
	<div class="container">
		<div class="navbar-header">
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="/pages/merchant.php">Процессинг</a></li>
...
<div class="container">
	<div class="row">
		<div class="col-md-12 ">
			...
			В личном кабинете, сгенерируйте клиенту уникальный адрес для пополнения счета. Переодически, скриптом проверяйте входящие транзакции на ваш кошелек.<br/>
