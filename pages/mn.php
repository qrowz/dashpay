...
<div class="container">
	<div class="row">
		<div class="col-md-12 ">
			...
			Владельцы мастернод получают часть монет от эмиссии за проведение анонимных/моментальных транзакций и раздачу blockchain.<br/>
			...
			Разместить мастерноду можно на операционной системе Windows, Linix и MacOS. Опытные пользователи могут <a href="https://forum.bits.media/index.php?/blog/191/entry-333-podnimaem-dash-masternode/" target="_blank">самостоятельно сделать это</a>.<br/>
			...
			Вы увидите номер вашей транзакции, через 50 минут напишите этот номер и нажмите кнопку "<u>получить masternode.conf</u>"<br/><br/>
			...
			Для этого в поиске укажите IP вашей мастерноды или адрес вашего кошелька (1000DASH).
			<br/>
			<br/>
		</div>
	</div>
